...
- Toolkit Doctor docs live in the source repo
  [G-Core/agent-toolkit/workflows/docs/toolkit-doctor.md](https://github.com/G-Core/agent-toolkit/blob/main/workflows/docs/toolkit-doctor.md)
...
6. References
   ...
   - point to toolkit examples under `.toolkit/` when relevant
